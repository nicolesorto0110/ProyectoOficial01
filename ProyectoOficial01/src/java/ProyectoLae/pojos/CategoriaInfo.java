...
public class CategoriaInfo {
    ...
    public CategoriaInfo(String p_strCategoria, double p_dPrecio, String p_strSubCategoria, String p_strNombreProducto, String p_strDescripcion, int p_iExistencia) {
